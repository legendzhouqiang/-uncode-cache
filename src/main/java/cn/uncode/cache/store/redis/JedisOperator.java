...
public class JedisOperator {
    ...
    public JedisOperator(JedisClusterCustom jedisClusterCustom) {
        this.jedisClusterCustom = jedisClusterCustom;
    }
    ...
    public <T> T execute(JedisExecutor<T> executor) {
        T result = null;
        try {
            result = executor.doInJedis(jedisClusterCustom);
        } catch (Exception e) {
            throw e;
        }
        return result;
    ...
    public JedisClusterCustom getJedisClusterCustom() {
...
//            @Override
//            public Object doInJedis(JedisClusterCustom jedis) {
...
//    }
    ...
    public String set(final String key, final String value) {
        return execute(new JedisExecutor<String>() {
            @Override
            public String doInJedis(JedisClusterCustom jedis) {
    ...
    public String get(final String key) {
        return execute(new JedisExecutor<String>() {
            @Override
            String doInJedis(JedisClusterCustom jedis) {
    ...
    public Boolean exists(final String key) {
        return execute(new JedisExecutor<Boolean>() {
            @Override
            Boolean doInJedis(JedisClusterCustom jedis) {
    ...
    public Long expire(final String key, final int seconds) {
        return execute(new JedisExecutor<Long>() {
            @Override
            Long doInJedis(JedisClusterCustom jedis) {
    ...
    public void flushAll() {
        execute(new JedisExecutor<Void>() {
            @Override
            public Void doInJedis(JedisClusterCustom jedis) {
                jedis.flushAll();
                return null;
            }
        });
    ...
    public Set<String> keys(final String pattern) {
        return execute(new JedisExecutor<Set<String>>() {
            @Override
            Set<String> doInJedis(JedisClusterCustom jedis) {
    ...
    public List<String> mget(final String... keys) {
        return execute(new JedisExecutor<List<String>>() {
            @Override
            List<String> doInJedis(JedisClusterCustom jedis) {
    ...
    public Map<String, String> hgetAll(final String key) {
        return execute(new JedisExecutor<Map<String, String>>() {
            @Override
            Map<String, String> doInJedis(JedisClusterCustom jedis) {
    ...
    public Double zincrby(final String key, final double score, final String member) {
        return execute(new JedisExecutor<Double>() {
            @Override
            Double doInJedis(JedisClusterCustom jedis) {
    ...
    public Set<redis.clients.jedis.Tuple> zrangeWithScores(final String key, final int start, final int end) {
        return execute(new JedisExecutor<Set<redis.clients.jedis.Tuple>>() {
            @Override
            Set<redis.clients.jedis.Tuple> doInJedis(JedisClusterCustom jedis) {
    ...
    public byte[] get(final byte[] key) {
        return execute(new JedisExecutor<byte[]>() {
            @Override
            byte[] doInJedis(JedisClusterCustom jedis) {
                return jedis.get(key);
            }
        });
    }
    ...
    public Set<byte[]> keys(final byte[] pattern) {
        return execute(new JedisExecutor<Set<byte[]>>() {
            @Override
            Set<byte[]> doInJedis(JedisClusterCustom jedis) {
                return jedis.keys(pattern);
            }
        });
    }
    ...
    public List<byte[]> mget(final byte[]... keys) {
        return execute(new JedisExecutor<List<byte[]>>() {
            @Override
            List<byte[]> doInJedis(JedisClusterCustom jedis) {
                return jedis.mget(keys);
            }
        });
    }
    ...
    public Collection<byte[]> hvals(final byte[] key) {
        return execute(new JedisExecutor<Collection<byte[]>>() {
            @Override
            Collection<byte[]> doInJedis(JedisClusterCustom jedis) {
                return jedis.hvals(key);
            }
        });
    }
    ...
    public Map<byte[], byte[]> hgetAll(final byte[] key) {
        return execute(new JedisExecutor<Map<byte[], byte[]>>() {
            @Override
            Map<byte[], byte[]> doInJedis(JedisClusterCustom jedis) {
                return jedis.hgetAll(key);
            }
        });
    }
    ...
    public void subscribe(final JedisPubSub jedisPubSub, final String... channels) {
        execute(new JedisExecutor<Void>() {
            @Override
            Void doInJedis(JedisClusterCustom jedis) {
    ...
    // getter & setter
    // ---------------------------------------------------------------------------------------------------
	public void setJedisClusterCustom(JedisClusterCustom jedisClusterCustom) {
		this.jedisClusterCustom = jedisClusterCustom;
	}
